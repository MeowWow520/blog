...
const initLazyLoad = () => {
  document.querySelectorAll(".home-article-cover img, .archive-post-cover img, .Diary-Postgraduate-content img, .album-cover-img, #album-content-links img").forEach((element) => {
